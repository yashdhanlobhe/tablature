...
Original file is located at
    https://colab.research.google.com/drive/1NLWT18Muk5a9UsBwYNqHggoAUCka2h22
"""
...
from tayuya.midi import MIDIParser
...
from tayuya import MIDIParser
path = "/Users/user/Downloads/test.mid"
mid=MIDIParser(path)
print(mid.get_tracks())

tracks = int(input("Enter the track number: "))
...
print(tabs.generate_notes()) #(note, string, fret)
